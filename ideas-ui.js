...
(function(root){
  ...
  function renderVault(){
    const tabs = [{id:'all',label:'All'}, ...IDEA_STATUSES.map(s=>({id:s,label:STATUS_LABELS[s]}))];
  ...
  function renderWorkspace(){
    ...
    panel.innerHTML =
      ...
      '<select id="ihWsStatus" class="ih-ws-select">'+IDEA_STATUSES.map(s=>
  ...
  function bindHubEvents(){
    ...
    if(!panel || panel.dataset.ihBound) return;
